...
public class RobotContainer {
  ...
  private void setupDrive() {
    ...
    Command teleopDriveCommand = swerve.teleopCommand(
        () -> applySpeedCurve(forwardLimiter.calculate(driverJoystick.forward())),
        () -> applySpeedCurve(strafeLimiter.calculate(driverJoystick.strafe())),
        () -> applySpeedCurve(turnLimiter.calculate(driverJoystick.turn())));
